  ...
  return (
    <Dialog open={isOpen} onOpenChange={closePopup}>
      <DialogContent className="bg-transparent shadow-none border-none p-0 max-w-none rounded-none">
        <div className="mx-auto w-full max-w-[52rem] p-6 sm:p-8 rounded-[28px] bg-white dark:bg-white backdrop-blur-md shadow transition-transform duration-200 hover:scale-[1.02]">
          <div className="h-60" />
