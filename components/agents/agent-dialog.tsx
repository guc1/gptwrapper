  ...
  return (
    <Dialog open={isOpen} onOpenChange={closePopup}>
      <DialogContent className="bg-transparent shadow-none border-none p-0 max-w-none rounded-none">
        <div className="relative mx-auto w-full max-w-[52rem] p-6 sm:p-8 rounded-[28px] bg-white/90 dark:bg-gray-900/80 backdrop-blur-md shadow transition-transform duration-200 hover:scale-[1.02]">
          <div className="pointer-events-none absolute inset-0 rounded-[28px] bg-[#f0f0f0] dark:bg-gray-900" />
          <div className="h-60" />
