...
export function Chat({
  ...
  useEffect(() => {
    ...
    if (url.searchParams.get('modelId') !== chatModelId) {
      url.searchParams.set('modelId', chatModelId);
    ...
    <>
      <div className="flex flex-col min-w-0 h-dvh bg-background">
        ...
        <form
          ...
          className="flex mx-auto px-4 bg-background pb-4 md:pb-6 gap-2 w-full md:max-w-[60rem]"
        >
          {!isReadonly && (
            <MultimodalInput
              chatId={id}
