...
export const translations = {
  en: {
    ...
    aiAgentsSubtitle: "a place where AI's collaborate to create magic",
    recentlyUsed: 'Recently Used',
    startUsingAgents: 'Start using agents!!',
    searchAgents: 'Search Agents',
    askAboutAgentsPlaceholder: 'Ask about agents...',
  ...
  nl: {
    ...
    agents: 'Agenten',
    aiAgentsTitle: 'AI-AGENTEN',
    aiAgentsSubtitle: "een plek waar AI's samenwerken om magie te creëren",
    recentlyUsed: 'Recent gebruikt',
    startUsingAgents: 'Begin met het gebruiken van agenten!!',
    searchAgents: 'Zoek agenten',
    askAboutAgentsPlaceholder: 'Vraag naar agenten...',
