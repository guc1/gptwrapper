...
export const translations = {
  en: {
    ...
    domainAgentDescription: 'Brainstorms and checks domain names',
    describeBusiness: 'Describe the business or project:',
    localMode: 'Local mode',
    modelMode: 'Model mode',
    selectCreators: 'Select creators',
    generationCount: 'Domains per creator',
    continueQuestion: 'Continue?',
    feedbackPlaceholder: 'Why did you choose this?',
    chatEnded: 'Session ended',
  },
  nl: {
    ...
    domainAgentDescription: 'Bedenkt en controleert domeinnamen',
    describeBusiness: 'Beschrijf het bedrijf of project:',
    localMode: 'Lokale modus',
    modelMode: 'Modelmodus',
    selectCreators: 'Selecteer makers',
    generationCount: 'Aantal domeinen per maker',
    continueQuestion: 'Doorgaan?',
    feedbackPlaceholder: 'Waarom vind je dit?',
    chatEnded: 'Sessie afgelopen',
  },
} as const;
