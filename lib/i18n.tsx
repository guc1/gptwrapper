...
export const translations = {
  en: {
    ...
    aiAssistentenTitle: 'AI ASSISTANTS',
    aiAssistentenSubtitle: 'Discover and craft custom AI assistants that amplify your talents.',
    recentlyUsed: 'Recently Used',
    startUsingAssistenten: 'Start using assistants!!',
    searchAssistenten: 'Search Assistants',
    askAboutAssistentenPlaceholder: 'Search for the perfect assistant for you.',
  ...
  nl: {
    ...
    aiAssistentenTitle: 'AI-ASSISTENTEN',
    aiAssistentenSubtitle: 'Ontdek en maak op maat gemaakte AI-assistenten die jouw talenten versterken.',
    recentlyUsed: 'Recent gebruikt',
    startUsingAssistenten: 'Begin met het gebruiken van assistenten!!',
    searchAssistenten: 'Zoek assistenten',
    askAboutAssistentenPlaceholder: 'Zoek de perfecte assistent voor jouw.',
