...
export const translations = {
  en: {
    ...
    domainAgentName: 'Domain Agent',
    domainAgentDescription: 'Generate and check domain names',
    domainProjectPrompt: 'Describe the business or project:',
    modeLabel: 'Mode',
    domainSuggested: 'Suggested domains',
    local: 'Local',
    model: 'Model',
    creators: 'Creators',
    domainsPerAgent: 'Domains per agent',
  ...
  nl: {
    ...
    domainAgentName: 'Domeinassistent',
    domainAgentDescription: 'Genereer en controleer domeinnamen',
    domainProjectPrompt: 'Beschrijf het bedrijf of project:',
    modeLabel: 'Modus',
    domainSuggested: 'Voorgestelde domeinen',
    local: 'Lokaal',
    model: 'Model',
    creators: 'Makers',
    domainsPerAgent: 'Domeinen per agent',
    conversationComplete: 'Sessie voltooid.',
  },
} as const;
